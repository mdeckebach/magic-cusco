...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - All Rights Reserved'
...
# (translatable)
SOCIAL_BUTTONS_CODE = """
<script src="https://kit.fontawesome.com/40d981c43f.js" crossorigin="anonymous"></script>
"""
# SOCIAL_BUTTONS_CODE = """
# <!-- Social buttons -->
